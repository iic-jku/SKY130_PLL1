...
C {devices/lab_pin.sym} 720 -340 0 0 {name=p6 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 720 -260 0 0 {name=p8 sig_type=std_logic lab=vss}
...
C {devices/lab_pin.sym} 890 -300 0 1 {name=p19 sig_type=std_logic lab=ref_in}
...
C {out_buf.sym} 560 -470 0 0 {name=x3}
C {esd.sym} 620 -200 0 0 {name=x1}
C {full_IC_1_noplane.sym} 230 -380 0 0 {name=x2}
