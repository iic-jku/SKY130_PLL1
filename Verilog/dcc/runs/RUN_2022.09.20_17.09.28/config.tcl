...
set ::env(DESIGN_CONFIG) {/foss/designs/dcc/config.tcl}
set ::env(DESIGN_DIR) {/foss/designs/dcc}
...
set ::env(GLB_CFG_FILE) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/config.tcl}
...
set ::env(LOGS_DIR) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports}
set ::env(RESULTS_DIR) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28}
...
set ::env(TMP_DIR) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/dcc/src/dcc.v}
...
set ::env(cts_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/cts}
set ::env(cts_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/cts}
set ::env(cts_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/cts}
set ::env(eco_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/eco}
set ::env(eco_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/eco}
set ::env(eco_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/eco}
set ::env(finishing_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/finishing}
set ::env(finishing_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/finishing}
set ::env(finishing_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/finishing}
set ::env(finishing_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/finishing}
set ::env(floorplan_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/placement}
set ::env(placement_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/placement}
set ::env(placement_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/placement}
set ::env(routing_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/routing}
set ::env(routing_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/routing}
set ::env(routing_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/routing}
set ::env(synthesis_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/synthesis}
...
set ::env(BOTTOM_MARGIN_MULT) {4}
set ::env(CARRY_SELECT_ADDER_MAP) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/csa_map.v}
set ::env(CELLS_LEF) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged.lef}
set ::env(CELLS_LEF_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef}
set ::env(CELLS_LEF_UNPADDED) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged_unpadded.lef}
set ::env(CELL_CLK_PORT) {CLK}
set ::env(CELL_PAD) {4}
set ::env(CELL_PAD_EXCLUDE) {sky130_fd_sc_hd__tap* sky130_fd_sc_hd__decap* sky130_fd_sc_hd__fill*}
set ::env(CHECK_ASSIGN_STATEMENTS) {0}
...
set ::env(CURRENT_INDEX) {1}
set ::env(CURRENT_NETLIST) {0}
set ::env(CURRENT_SDC) {/foss/tools/openlane/2022.04.07_02.53.08/scripts/base.sdc}
...
set ::env(LEFT_MARGIN_MULT) {12}
set ::env(LIB_FASTEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_RESIZER_OPT) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SLOWEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/synthesis/trimmed.lib}
set ::env(LIB_SYNTH_COMPLETE) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/synthesis/merged.lib}
set ::env(LIB_TYPICAL) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_INSERT_POWER_PINS) {1}
...
set ::env(MERGED_LEF) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged.lef}
set ::env(MERGED_LEF_ORIGINAL) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged.lef}
set ::env(MERGED_LEF_UNPADDED) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_UNPADDED_ORIGINAL) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_UNPADDED_WIDENED) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_WIDENED) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/merged.lef}
...
set ::env(SAVE_FINAL_VIEWS) {1}
set ::env(SAVE_NETLIST) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/synthesis/dcc.v}
...
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRACKS_INFO_FILE_PROCESSED) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/routing/config.tracks}
set ::env(TRISTATE_BUFFER_MAP) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
set ::env(USE_ARC_ANTENNA_CHECK) {1}
set ::env(USE_GPIO_PADS) {0}
...
set ::env(routing_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/routing}
set ::env(synth_report_prefix) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/dcc/runs/RUN_2022.09.20_17.09.28/tmp/synthesis}
set ::env(timer_end) {1663693771}
set ::env(timer_start) {1663693768}
