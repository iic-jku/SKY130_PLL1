module wrapper (clk_in,
 ...
 sky130_fd_sc_hd__inv_2 _1991_ (.A(_0751_),
    .Y(_0255_));
 sky130_fd_sc_hd__dfrtp_1 _1992_ (.CLK(clk_in),
    .D(_0256_),
    .RESET_B(_0021_),
    .Q(net17));
 sky130_fd_sc_hd__dfrtp_1 _1993_ (.CLK(clk_in),
    .D(_0257_),
    .RESET_B(_0022_),
    .Q(\d2.r_reg[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1994_ (.CLK(clk_in),
    .D(_0258_),
    .RESET_B(_0023_),
    .Q(\d2.r_reg[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1995_ (.CLK(clk_in),
    .D(_0259_),
    .RESET_B(_0024_),
    .Q(\d2.r_reg[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1996_ (.CLK(clk_in),
    .D(_0260_),
    .RESET_B(_0025_),
    .Q(\d2.r_reg[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1997_ (.CLK(clk_in),
    .D(_0261_),
    .RESET_B(_0026_),
    .Q(\d2.r_reg[5] ));
 sky130_fd_sc_hd__dfrtp_1 _1998_ (.CLK(clk_in),
    .D(_0262_),
    .RESET_B(_0027_),
    .Q(\d2.r_reg[6] ));
 sky130_fd_sc_hd__dfrtp_1 _1999_ (.CLK(clk_in),
    .D(_0263_),
    .RESET_B(_0028_),
    .Q(\d2.r_reg[7] ));
 sky130_fd_sc_hd__dfrtp_1 _2000_ (.CLK(clk_in),
    .D(_0264_),
    .RESET_B(_0029_),
    .Q(\d2.r_reg[8] ));
 sky130_fd_sc_hd__dfrtp_1 _2001_ (.CLK(clk_in),
    .D(_0265_),
    .RESET_B(_0030_),
    .Q(\d2.r_reg[9] ));
 sky130_fd_sc_hd__dfrtp_1 _2002_ (.CLK(clk_in),
    .D(_0266_),
    .RESET_B(_0031_),
    .Q(\d2.r_reg[10] ));
 sky130_fd_sc_hd__dfrtp_1 _2003_ (.CLK(clk_in),
    .D(_0267_),
    .RESET_B(_0032_),
    .Q(\d2.r_reg[11] ));
 sky130_fd_sc_hd__dfrtp_1 _2004_ (.CLK(clk_in),
    .D(_0268_),
    .RESET_B(_0033_),
    .Q(\d2.r_reg[12] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2087_ (.CLK(clk_in),
    ...
    .RESET_B(_0116_),
    .Q(\d2.r_reg[95] ));
 sky130_fd_sc_hd__dfxtp_1 _2088_ (.CLK(ref_in),
    .D(_0352_),
    .Q(\d5.fll_core.corner_tmp[0] ));
 sky130_fd_sc_hd__dfxtp_1 _2089_ (.CLK(ref_in),
    .D(_0353_),
    .Q(\d5.fll_core.corner_tmp[1] ));
 sky130_fd_sc_hd__dfxtp_1 _2090_ (.CLK(ref_in),
    .D(_0354_),
    .Q(\d5.fll_core.corner_tmp[2] ));
 sky130_fd_sc_hd__dfrtp_4 _2091_ (.CLK(ref_in),
    .D(_0000_),
    .RESET_B(_0117_),
 ...
 sky130_fd_sc_hd__dfrtp_1 _2100_ (.CLK(clk_in),
    ...
    .RESET_B(_0126_),
    .Q(\d2.t_load[8] ));
 sky130_fd_sc_hd__dfrtp_1 _2101_ (.CLK(clk_in),
    .D(_0364_),
    .RESET_B(_0127_),
    .Q(\d2.t_load[9] ));
 sky130_fd_sc_hd__dfrtp_1 _2102_ (.CLK(clk_in),
    .D(_0365_),
    .RESET_B(_0128_),
    .Q(\d2.t_load[10] ));
 sky130_fd_sc_hd__dfrtp_1 _2103_ (.CLK(clk_in),
    .D(_0366_),
    .RESET_B(_0129_),
    .Q(\d2.t_load[11] ));
 sky130_fd_sc_hd__dfrtp_1 _2104_ (.CLK(clk_in),
    .D(_0367_),
    .RESET_B(_0130_),
    .Q(\d2.t_load[12] ));
 sky130_fd_sc_hd__dfrtp_1 _2105_ (.CLK(clk_in),
    .D(_0368_),
    .RESET_B(_0131_),
    .Q(\d2.t_load[13] ));
 sky130_fd_sc_hd__dfrtp_1 _2106_ (.CLK(clk_in),
    .D(_0369_),
    .RESET_B(_0132_),
    .Q(\d2.t_load[14] ));
 sky130_fd_sc_hd__dfrtp_1 _2107_ (.CLK(clk_in),
    .D(_0370_),
    .RESET_B(_0133_),
    .Q(\d2.t_load[15] ));
 sky130_fd_sc_hd__dfrtp_1 _2108_ (.CLK(clk_in),
    .D(_0371_),
    .RESET_B(_0134_),
    .Q(\d2.t_load[16] ));
 sky130_fd_sc_hd__dfrtp_1 _2109_ (.CLK(clk_in),
    .D(_0372_),
    .RESET_B(_0135_),
    .Q(\d2.t_load[17] ));
 sky130_fd_sc_hd__dfrtp_1 _2110_ (.CLK(clk_in),
    .D(_0373_),
    .RESET_B(_0136_),
    .Q(\d2.t_load[18] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2124_ (.CLK(clk_in),
    ...
    .RESET_B(_0150_),
    .Q(\d2.t_load[32] ));
 sky130_fd_sc_hd__dfrtp_4 _2125_ (.CLK(clk_in),
    .D(_0388_),
    .RESET_B(_0151_),
    .Q(\d2.t_load[33] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2135_ (.CLK(clk_in),
    ...
    .RESET_B(_0161_),
    .Q(\d2.t_load[43] ));
 sky130_fd_sc_hd__dfrtp_4 _2136_ (.CLK(clk_in),
    .D(_0399_),
    .RESET_B(_0162_),
    .Q(\d2.t_load[44] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2143_ (.CLK(clk_in),
    ...
    .RESET_B(_0169_),
    .Q(\d2.t_load[51] ));
 sky130_fd_sc_hd__dfrtp_1 _2144_ (.CLK(clk_in),
    .D(_0407_),
    .RESET_B(_0170_),
    .Q(\d2.t_load[52] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2154_ (.CLK(clk_in),
    ...
    .RESET_B(_0180_),
    .Q(\d2.t_load[62] ));
 sky130_fd_sc_hd__dfrtp_1 _2155_ (.CLK(clk_in),
    .D(_0418_),
    .RESET_B(_0181_),
    .Q(\d2.t_load[63] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2169_ (.CLK(clk_in),
    ...
    .RESET_B(_0195_),
    .Q(net27));
 sky130_fd_sc_hd__dfrtp_2 _2170_ (.CLK(clk_in),
    .D(_0433_),
    .RESET_B(_0196_),
    .Q(net28));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2177_ (.CLK(clk_in),
    ...
    .RESET_B(_0203_),
    .Q(net35));
 sky130_fd_sc_hd__dfrtp_1 _2178_ (.CLK(clk_in),
    .D(_0441_),
    .RESET_B(_0204_),
    .Q(net36));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2186_ (.CLK(clk_in),
    ...
    .RESET_B(_0212_),
    .Q(net44));
 sky130_fd_sc_hd__dfrtp_1 _2187_ (.CLK(clk_in),
    .D(_0450_),
    .RESET_B(_0213_),
    .Q(\d2.t_load[95] ));
 sky130_fd_sc_hd__dfstp_1 _2188_ (.CLK(ref_in),
    .D(_0000_),
    .SET_B(_0214_),
    .Q(\d5.fll_core.counter_reset ));
 sky130_fd_sc_hd__dfrtp_1 _2189_ (.CLK(ref_in),
    .D(_0451_),
    .RESET_B(_0215_),
    .Q(\d5.fll_core.locked ));
 sky130_fd_sc_hd__dfstp_2 _2190_ (.CLK(ref_in),
    .D(_0452_),
    .SET_B(_0216_),
    .Q(\d5.fll_core.tmp[0] ));
 sky130_fd_sc_hd__dfrtp_1 _2191_ (.CLK(ref_in),
    .D(_0453_),
    .RESET_B(_0217_),
    .Q(\d5.fll_core.tmp[1] ));
 sky130_fd_sc_hd__dfrtp_2 _2192_ (.CLK(ref_in),
    .D(_0454_),
    .RESET_B(_0218_),
    .Q(\d5.fll_core.tmp[2] ));
 sky130_fd_sc_hd__dfrtp_2 _2193_ (.CLK(ref_in),
    .D(_0455_),
    .RESET_B(_0219_),
    .Q(\d5.fll_core.tmp[3] ));
 sky130_fd_sc_hd__dfrtp_2 _2194_ (.CLK(ref_in),
    .D(_0456_),
    .RESET_B(_0220_),
    .Q(\d5.fll_core.tmp[4] ));
 sky130_fd_sc_hd__dfrtp_2 _2195_ (.CLK(ref_in),
    .D(_0457_),
    .RESET_B(_0221_),
    .Q(\d5.fll_core.tmp[5] ));
 sky130_fd_sc_hd__dfrtp_2 _2196_ (.CLK(ref_in),
    .D(_0458_),
    .RESET_B(_0222_),
    .Q(\d5.fll_core.tmp[6] ));
 sky130_fd_sc_hd__dfrtp_2 _2197_ (.CLK(ref_in),
    .D(_0459_),
    .RESET_B(_0223_),
    .Q(\d5.fll_core.tmp[7] ));
 sky130_fd_sc_hd__dfrtp_2 _2198_ (.CLK(ref_in),
    .D(_0460_),
    .RESET_B(_0224_),
    .Q(\d5.fll_core.tmp[8] ));
 sky130_fd_sc_hd__dfrtp_2 _2199_ (.CLK(ref_in),
    .D(_0461_),
    .RESET_B(_0225_),
    .Q(\d5.fll_core.tmp[9] ));
 sky130_fd_sc_hd__dfrtp_2 _2200_ (.CLK(vco_in),
    .D(_0001_),
    .RESET_B(_0226_),
    .Q(\d5.fll_core.counter1.count[0] ));
 sky130_fd_sc_hd__dfrtp_2 _2201_ (.CLK(vco_in),
    .D(_0002_),
    .RESET_B(_0227_),
    .Q(\d5.fll_core.counter1.count[1] ));
 sky130_fd_sc_hd__dfrtp_1 _2202_ (.CLK(vco_in),
    .D(_0003_),
    .RESET_B(_0228_),
    .Q(\d5.fll_core.counter1.count[2] ));
 sky130_fd_sc_hd__dfrtp_1 _2203_ (.CLK(vco_in),
    .D(_0004_),
    .RESET_B(_0229_),
    .Q(\d5.fll_core.counter1.count[3] ));
 sky130_fd_sc_hd__dfrtp_1 _2204_ (.CLK(vco_in),
    .D(_0005_),
    .RESET_B(_0230_),
    .Q(\d5.fll_core.counter1.count[4] ));
 sky130_fd_sc_hd__dfrtp_1 _2205_ (.CLK(vco_in),
    .D(_0006_),
    .RESET_B(_0231_),
    .Q(\d5.fll_core.counter1.count[5] ));
 sky130_fd_sc_hd__dfrtp_1 _2206_ (.CLK(vco_in),
    .D(_0007_),
    .RESET_B(_0232_),
    .Q(\d5.fll_core.counter1.count[6] ));
 sky130_fd_sc_hd__dfrtp_1 _2207_ (.CLK(vco_in),
    .D(_0008_),
    .RESET_B(_0233_),
    .Q(\d5.fll_core.counter1.count[7] ));
 sky130_fd_sc_hd__dfrtp_1 _2208_ (.CLK(vco_in),
    .D(_0009_),
    .RESET_B(_0234_),
    .Q(\d5.fll_core.counter1.count[8] ));
 sky130_fd_sc_hd__dfrtp_1 _2209_ (.CLK(vco_in),
    .D(_0010_),
    .RESET_B(_0235_),
    .Q(\d5.fll_core.counter1.count[9] ));
 sky130_fd_sc_hd__dfrtp_2 _2210_ (.CLK(ref_in),
    .D(_0011_),
    .RESET_B(_0236_),
    .Q(\d5.fll_core.counter2.count[0] ));
 sky130_fd_sc_hd__dfrtp_1 _2211_ (.CLK(ref_in),
    .D(_0012_),
    .RESET_B(_0237_),
    .Q(\d5.fll_core.counter2.count[1] ));
 sky130_fd_sc_hd__dfrtp_1 _2212_ (.CLK(ref_in),
    .D(_0013_),
    .RESET_B(_0238_),
    .Q(\d5.fll_core.counter2.count[2] ));
 sky130_fd_sc_hd__dfrtp_1 _2213_ (.CLK(ref_in),
    .D(_0014_),
    .RESET_B(_0239_),
    .Q(\d5.fll_core.counter2.count[3] ));
 sky130_fd_sc_hd__dfrtp_1 _2214_ (.CLK(ref_in),
    .D(_0015_),
    .RESET_B(_0240_),
    .Q(\d5.fll_core.counter2.count[4] ));
 sky130_fd_sc_hd__dfrtp_1 _2215_ (.CLK(ref_in),
    .D(_0016_),
    .RESET_B(_0241_),
    .Q(\d5.fll_core.counter2.count[5] ));
 sky130_fd_sc_hd__dfrtp_1 _2216_ (.CLK(ref_in),
    .D(_0017_),
    .RESET_B(_0242_),
    .Q(\d5.fll_core.counter2.count[6] ));
 sky130_fd_sc_hd__dfrtp_1 _2217_ (.CLK(ref_in),
    .D(_0018_),
    .RESET_B(_0243_),
    .Q(\d5.fll_core.counter2.count[7] ));
 sky130_fd_sc_hd__dfrtp_1 _2218_ (.CLK(ref_in),
    .D(_0019_),
    .RESET_B(_0244_),
    .Q(\d5.fll_core.counter2.count[8] ));
 sky130_fd_sc_hd__dfrtp_1 _2219_ (.CLK(ref_in),
    .D(_0020_),
    .RESET_B(_0245_),
