...
set ::env(DESIGN_CONFIG) {/foss/designs/ma2022/clk_divider/config.tcl}
set ::env(DESIGN_DIR) {/foss/designs/ma2022/clk_divider}
...
set ::env(GLB_CFG_FILE) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/config.tcl}
...
set ::env(LOGS_DIR) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports}
set ::env(RESULTS_DIR) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03}
...
set ::env(TMP_DIR) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/ma2022/clk_divider/src/clk_divider.v}
...
set ::env(cts_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/cts}
set ::env(cts_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/cts}
set ::env(cts_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/cts}
set ::env(eco_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/eco}
set ::env(eco_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/eco}
set ::env(eco_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/eco}
set ::env(finishing_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/finishing}
set ::env(finishing_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/finishing}
set ::env(finishing_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/finishing}
set ::env(finishing_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/finishing}
set ::env(floorplan_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/placement}
set ::env(placement_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/placement}
set ::env(placement_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/placement}
set ::env(routing_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/routing}
set ::env(routing_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/routing}
set ::env(routing_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/routing}
set ::env(synthesis_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_DEF) /foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/floorplan/clk_divider.def
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_INDEX) 6
set ::env(CURRENT_NETLIST) /foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/synthesis/clk_divider.v
...
set ::env(BOTTOM_MARGIN_MULT) {4}
set ::env(CARRY_SELECT_ADDER_MAP) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/csa_map.v}
set ::env(CELLS_LEF) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged.lef}
set ::env(CELLS_LEF_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef}
set ::env(CELLS_LEF_UNPADDED) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged_unpadded.lef}
set ::env(CELL_CLK_PORT) {CLK}
set ::env(CELL_PAD) {4}
set ::env(CELL_PAD_EXCLUDE) {sky130_fd_sc_hd__tap* sky130_fd_sc_hd__decap* sky130_fd_sc_hd__fill*}
set ::env(CHECK_ASSIGN_STATEMENTS) {0}
...
set ::env(CONFIGS) {/foss/tools/openlane/2022.04.07_02.53.08/configuration/placement.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/general.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/extraction.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/lvs.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/routing.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/cts.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/floorplan.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/synthesis.tcl /foss/tools/openlane/2022.04.07_02.53.08/configuration/checkers.tcl}
set ::env(CORE_AREA) {5.52 10.88 8.74 13.6}
set ::env(CORE_HEIGHT) {2.72}
set ::env(CORE_WIDTH) {3.22}
set ::env(CTS_CLK_BUFFER_LIST) {sky130_fd_sc_hd__clkbuf_2 sky130_fd_sc_hd__clkbuf_4 sky130_fd_sc_hd__clkbuf_8}
set ::env(CTS_CLK_MAX_WIRE_LENGTH) {0}
set ::env(CTS_DISABLE_POST_PROCESSING) {0}
set ::env(CTS_DISTANCE_BETWEEN_BUFFERS) {0}
...
set ::env(CURRENT_INDEX) {6}
set ::env(CURRENT_NETLIST) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/synthesis/clk_divider.v}
set ::env(CURRENT_SDC) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/floorplan/3-initial_fp.sdc}
...
set ::env(DETAILED_ROUTER) {tritonroute}
set ::env(DIE_AREA) {0.0 0.0 14.575 25.295}
set ::env(DIODE_CELL) {sky130_fd_sc_hd__diode_2}
set ::env(DIODE_CELL_PIN) {DIODE}
set ::env(DIODE_INSERTION_STRATEGY) {3}
set ::env(DIODE_PADDING) {2}
...
set ::env(LAST_TIMING_REPORT_TAG) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/synthesis/2-synthesis_sta}
set ::env(LAYERS_RC) { li1 1.499e-04 7.176e-02, met1 1.449e-04 8.929e-04, met2 1.331e-04 8.929e-04, met3 1.464e-04 1.567e-04, met4 1.297e-04 1.567e-04, met5 1.501e-04 1.781e-05}
...
set ::env(LEFT_MARGIN_MULT) {12}
set ::env(LIB_FASTEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_RESIZER_OPT) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SLOWEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/synthesis/trimmed.lib}
set ::env(LIB_SYNTH_COMPLETE) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/synthesis/merged.lib}
set ::env(LIB_TYPICAL) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_INSERT_POWER_PINS) {1}
...
set ::env(MERGED_LEF) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged.lef}
set ::env(MERGED_LEF_ORIGINAL) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged.lef}
set ::env(MERGED_LEF_UNPADDED) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_UNPADDED_ORIGINAL) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_UNPADDED_WIDENED) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_WIDENED) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/merged.lef}
...
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(PDN_CFG) {/foss/tools/openlane/2022.04.07_02.53.08/scripts/openroad/pdn_cfg.tcl}
set ::env(PGA_RPT_FILE) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/floorplan/6-pdn.pga.rpt}
set ::env(PLACE_SITE) {unithd}
set ::env(PLACE_SITE_HEIGHT) {2.720}
set ::env(PLACE_SITE_WIDTH) {0.460}
set ::env(PL_BASIC_PLACEMENT) {0}
...
set ::env(SAVE_DEF) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/floorplan/6-pdn.def}
set ::env(SAVE_FINAL_VIEWS) {1}
set ::env(SAVE_NETLIST) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/synthesis/clk_divider.v}
set ::env(SAVE_SDC) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/floorplan/3-initial_fp.sdc}
...
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRACKS_INFO_FILE_PROCESSED) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/routing/config.tracks}
set ::env(TRISTATE_BUFFER_MAP) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
set ::env(USE_ARC_ANTENNA_CHECK) {1}
set ::env(USE_GPIO_PADS) {0}
...
set ::env(floorplan_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/floorplan}
set ::env(fp_report_prefix) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/floorplan/3-initial_fp}
set ::env(placement_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/placement}
set ::env(placement_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/placement}
set ::env(placement_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/placement}
...
set ::env(routing_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/routing}
set ::env(synth_report_prefix) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/ma2022/clk_divider/runs/RUN_2022.10.07_16.22.03/tmp/synthesis}
set ::env(timer_start) {1665159723}
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(ATALANTA_MAN) {/usr/local/share/atalanta}
set ::env(BASE_SDC_FILE) {/foss/tools/openlane/2022.04.07_02.53.08/scripts/base.sdc}
set ::env(BOTTOM_MARGIN_MULT) {4}
