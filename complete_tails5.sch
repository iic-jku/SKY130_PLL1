...
N -200 -90 -130 -50 {
lab=#net2}
C {delay_cell.sym} 20 -30 0 0 {name=x1}
C {delay_cell.sym} 440 -30 0 0 {name=x2}
C {delay_cell.sym} 850 -30 0 0 {name=x3}
C {delay_cell.sym} 1260 -30 0 0 {name=x4}
...
C {devices/vdd.sym} -140 200 2 0 {name=l31 lab=tail}
...
fft tran1.c tran2.c tran3.c tran4.c tran5.c tran6.c tran7.c tran8.c tran9.c tran10.c
...
plot db(mag(fft(tran1.c))) db(mag(fft(tran2.c))) db(mag(fft(tran3.c))) db(mag(fft(tran4.c))) db(mag(fft(tran5.c))) db(mag(fft(tran6.c))) db(mag(fft(tran7.c))) db(mag(fft(tran8.c))) db(mag(fft(tran9.c))) db(mag(fft(tran10.c))) xlimit 0.1g 10g
.endc
.end
"}
...
C {devices/vdd.sym} 280 200 2 0 {name=l24 lab=tail}
C {devices/vdd.sym} 690 200 2 0 {name=l25 lab=tail}
C {devices/vdd.sym} 1100 200 2 0 {name=l47 lab=tail}
...
C {devices/vdd.sym} -200 130 3 0 {name=l48 lab=bit0}
C {devices/vdd.sym} 220 130 3 0 {name=l49 lab=bit0}
C {devices/vdd.sym} 630 130 3 0 {name=l50 lab=bit0}
C {devices/vdd.sym} 1040 130 3 0 {name=l51 lab=bit0}
C {devices/vdd.sym} -200 150 3 0 {name=l52 lab=bit1}
C {devices/vdd.sym} -200 170 3 0 {name=l53 lab=bit2}
C {devices/vdd.sym} 220 150 3 0 {name=l54 lab=bit1}
C {devices/vdd.sym} 220 170 3 0 {name=l55 lab=bit2}
C {devices/vdd.sym} 630 150 3 0 {name=l56 lab=bit1}
C {devices/vdd.sym} 630 170 3 0 {name=l57 lab=bit2}
C {devices/vdd.sym} 1040 150 3 0 {name=l58 lab=bit1}
C {devices/vdd.sym} 1040 170 3 0 {name=l59 lab=bit2}
...
C {devices/vdd.sym} -140 100 0 0 {name=l9 lab=tail2}
C {devices/vdd.sym} 280 100 0 0 {name=l10 lab=tail2}
C {devices/vdd.sym} 690 100 0 0 {name=l11 lab=tail2}
C {devices/vdd.sym} 1100 100 0 0 {name=l12 lab=tail2}
C {ma2022/current_sw1.sym} -50 180 0 0 {name=x9}
C {devices/vdd.sym} -60 170 1 0 {name=l61 lab=vc}
C {ma2022/current_sw1.sym} 370 180 0 0 {name=x10}
C {ma2022/current_sw1.sym} 780 180 0 0 {name=x11}
C {ma2022/current_sw1.sym} 1190 180 0 0 {name=x12}
C {devices/vdd.sym} 360 170 1 0 {name=l62 lab=vc}
C {devices/vdd.sym} 770 170 1 0 {name=l63 lab=vc}
C {devices/vdd.sym} 1180 170 1 0 {name=l64 lab=vc}
