...
#set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { debug2  }]; #IO_L5P_T0_D06_14             Sch=ck_io[4]
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { debug3  }]; #IO_L14P_T2_SRCC_14           Sch=ck_io[5]

#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports { debug0 }];             #IO_L14N_T2_SRCC_14 Sch=ck_io[6]
#set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports { debug1 }];             #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ck_io[7]
set_property -dict { PACKAGE_PIN N15 IOSTANDARD LVCMOS33 } [get_ports { reset_to_chip }];      #IO_L11P_T1_SRCC_14 Sch=ck_io[8]
set_property -dict { PACKAGE_PIN M16 IOSTANDARD LVCMOS33 } [get_ports { REG_CLK }];             #IO_L10P_T1_D14_14 Sch=ck_io[9]
...
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports { SIN }];               #IO_L12N_T1_MRCC_14 Sch=ck_io[12]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports { SOUT }];               #IO_L12P_T1_MRCC_14 Sch=ck_io[13]
...
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { reset_to_chip_mgmt }]; #IO_0_35           	Sch=ck_a[0]		ChipKit pin=A0
